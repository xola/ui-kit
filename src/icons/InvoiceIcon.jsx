...
export const InvoiceIcon = (props) => (
    <svg width={14} height={14} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        />
        <path
            d="M8.259 1.558v2.345c0 .262.21.473.478.473h2.345"
            stroke="currentColor"
            strokeWidth={0.917}
            strokeLinecap="round"
            strokeLinejoin="round"
        />
        <path
            d="M6.906 5.625V5M7.844 5.625H6.569a.839.839 0 00-.844.838.84.84 0 00.525.774l1.29.513-.006-.006a.834.834 0 01.462 1.087.852.852 0 01-.78.525H5.937M6.906 10v-.625"
            stroke="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
        />
