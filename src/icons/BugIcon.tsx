...
export const BugIcon = createIcon((props) => {
    return (
        <svg viewBox="0 0 14 10" width={14} height={10} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            />
            <path d="M5.79883 1.5L4.79883 0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.79883 1.5L8.79883 0.5" strokeLinecap="round" strokeLinejoin="round" />
            <path
            ...
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M3.04883 5.75H1.29883" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12.2988 5.75H10.5488" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
});
