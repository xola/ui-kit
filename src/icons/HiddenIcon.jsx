...
export const HiddenIcon = createIcon((props) => {
    return (
        <svg viewBox="0 0 14 14" width={15} height={16} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path clipRule="evenodd" d="M.666 15l14-14-14 14v0z" stroke="#979797" strokeWidth={0.05} />
            <path d="M.666 1l14 14" stroke="#979797" strokeWidth={0.05} />
            <path
            ...
            />
            <path d="M9.708 15V1M5.624 15V1M7.666 15V1" stroke="#979797" strokeWidth={0.05} />
            <path
                clipRule="evenodd"
