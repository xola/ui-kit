...
export const Introduction = {
    render: () => (
        <div className="sb-unstyled max-w-4xl mx-auto p-8 space-y-4">
            <div>
                <h1 className="text-2xl font-semibold mb-4">Welcome to the Xola UI Kit</h1>
                <p className="text-lg">
            ...
            <div className="space-y-6">
                <div className="">
                    ...
                    <p className="text-md">
                        This UI Kit is a suite of React + Tailwind components and helper libraries that conform to
                        Xola's design system and brand guidelines set by Xola's design team. It includes components like
                        alerts, avatars, modals, tooltips, and much more.
                    </p>
                </div>
                ...
                <div className="bg-yellow-lighter px-4 py-6 rounded border border-yellow-light">
                    ...
                    <p className="text-gray-darker mb-4">
                        Click on each component in the left sidebar to view its design. Use the <strong>"Docs"</strong>{" "}
                        tab in the top toolbar to explore configuration parameters and try them out live! Click{" "}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg py-6">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center">
                                <span className="w-2 h-2 bg-black rounded-full mr-3"></span>
                                <span>
                                    <a href="https://storybook.js.org/" className="text-primary hover:underline">
                                        Storybook JS
                                    </a>{" "}
                                    v8.x
                                </span>
                            ...
                            <li className="flex items-center">
                                <span className="w-2 h-2 bg-black rounded-full mr-3"></span>
                                <span>
                                    <a href="https://vitejs.dev/" className="text-primary hover:underline">
                                        Vite
                                    </a>{" "}
                        ...
                        <p className="mt-4 text-sm text-gray-darker">
                            See <code className="bg-gray-lighter px-2 py-1 rounded text-sm">package.json</code> for
                            other packages
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg py-6">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a
                                    href="https://github.com/xola/ui-kit"
                ...
                <div className="rounded">
                    ...
                    <div className="space-y-2">
                        ...
                        <p>
                            ...
                            <a
                                href="https://github.com/xola/ui-kit/graphs/contributors"
                                className="text-primary hover:underline"
                            >
                                and more
                            </a>
