...
See [Installation](/story/installation--page) for installations & usage instructions

### Core Technologies

-   React v17 (using [hooks](https://reactjs.org/docs/hooks-overview.html))
-   [Tailwind CSS](https://tailwindcss.com) v3.x
-   [Storybook JS](https://storybook.js.org/) v6.x
...
-   Design - [Barthélémy Chalvet & Team Bruno](https://www.callbruno.com/en/), J Scott Zimmerman & Anush Ramani
-   Coding - Nemanja Krstić, Rushi Vishavadia [and more](https://github.com/xola/ui-kit/graphs/contributors)
