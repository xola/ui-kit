...
export const SidebarNotifications = ({
    ...
    return (
        <>
            <div
                className={cn(
                    "flex w-full gap-2 bg-black p-2",
            ...
            >
                {leftDrawer && (
                    <div className={cn("cursor-pointer text-center", leftDrawer.hide && "hidden")}>
                        ...
                        >
                            <AnnounceIcon className={cn(isCollapsed && "hidden")} />
                            {leftDrawer.count}
                        </Counter>
                    </div>
                )}
                ...
                {rightDrawer && (
                    <div className={cn("cursor-pointer text-center", !hasNoticeCount && "hidden")}>
                        <Counter
                            className="text-sm"
                            style={counterSize(isCollapsed)}
                            onClick={() => onDrawerStateChange?.("right")}
                        >
                            <BellIcon className={cn(isCollapsed && "hidden")} />
                            {rightDrawer.count}
                        </Counter>
                    </div>
                )}
