...
}`,...(S=(v=c.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};var k,O,x;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`({
  shouldCloseOnOutsideClick
}) => {
  const [isOpen, setIsOpen] = useState(false);
...
}`,...(x=(O=m.parameters)==null?void 0:O.docs)==null?void 0:x.source}}};const $=["Default","ScrollableContent","WithDatePicker"];export{d as Default,c as ScrollableContent,m as WithDatePicker,$ as __namedExportsOrder,W as default};
